			...
			<div id="updateNameSeq">
				<table border="0" cellpadding="0" cellspacing="0" class="style_grid" id="nicknamegrid">
					<tbody>
						...
						<g:if test="${userAccounts}">
							<g:set var="savingsAccount" value="${setnameseqrequest?.savingsAccount}" />
							<g:if test="${savingsAccount}">
								<g:each var="userAcc" in="${savingsAccount}">
									<tr>
										<td width="20%">
										...
										<td width="20%">
											<vayana:sequenceNumber name="sequence" id="sequence" seqsize="${savingsAccount?.size()}" value="${userAcc?.userAccountAttribute?.valueOrder}" required="required" data-errormessage="${g.message(code:"setnamesequence.sequence.error.message")}" />
										</td>
							...
							<g:set var="currentAccount" value="${setnameseqrequest?.currentAccount}" />
							<g:if test="${currentAccount}">
								<g:each var="userAcc" in="${currentAccount}">
									<tr>
										<td width="20%">
											${userAcc?.accountNumber}
											<g:hiddenField name="accountNumber" value="${userAcc?.accountNumber}" />
										...
										<td width="20%">
											<vayana:sequenceNumber name="sequence" id="sequence" seqsize="${currentAccount?.size()}" value="${userAcc?.userAccountAttribute?.valueOrder}" required="required" data-errormessage="${g.message(code:"setnamesequence.sequence.error.message")}" />
										</td>	
										<%--<td width="20%"><g:select name="sequence" id="sequence"
												from="${['0','1','2','3','4','5','6']}" keys="${0..6}" value="${userAcc?.userAccountAttribute?.valueOrder}"/></td>
							...
							<g:set var="loanAccount" value="${setnameseqrequest?.loanAccount}" />
							<g:if test="${loanAccount}">
								<g:each var="userAcc" in="${loanAccount}">
									<tr>
										<td width="20%">
											${userAcc?.accountNumber}
											<g:hiddenField name="accountNumber" value="${userAcc?.accountNumber}" />
										...
										<td width="20%">
											<vayana:sequenceNumber name="sequence" id="sequence" seqsize="${loanAccount?.size()}" value="${userAcc?.userAccountAttribute?.valueOrder}" required="required" data-errormessage="${g.message(code:"setnamesequence.sequence.error.message")}"  />
										</td>	
										<%--<td width="20%"><g:select name="sequence" id="sequence"
												from="${['0','1','2','3','4','5','6']}" keys="${0..6}" value="${userAcc?.userAccountAttribute?.valueOrder}"/></td>
							...
							<g:set var="depositAccount" value="${setnameseqrequest?.depositAccount}" />
							<g:if test="${depositAccount}">
								<g:each var="userAcc" in="${depositAccount}">
									<tr>
										<td width="20%">
											${userAcc?.accountNumber}
											<g:hiddenField name="accountNumber" value="${userAcc?.accountNumber}" />
										...
										<td width="20%">
											<vayana:sequenceNumber name="sequence" id="sequence" seqsize="${depositAccount?.size()}" value="${userAcc?.userAccountAttribute?.valueOrder}" required="required" data-errormessage="${g.message(code:"setnamesequence.sequence.error.message")}"  />
										</td>	
										<%--<td width="20%"><g:select name="sequence" id="sequence"
												from="${['0','1','2','3','4','5','6']}" keys="${0..6}" value="${userAcc?.userAccountAttribute?.valueOrder}"/></td>
				...
				<div class="buttons" id="button">				
						<vayana:submitToRemote value="${message(code:'userprofile.template.changesecureaccess.submit.button.text')}"
						   ...
						   update="[failure:'messagesDiv',success:'messagesDiv']"
						   onSuccess="onNickNameUpdateSuccess();" 
