...
<html>
	<head>
		...
		<script>
		function onloaded(){if(parent.location.href!=location.href) top.location.href=location.href;}
	...
	<body  >
		...
		<div id="status" role="complementary">
			<h2>Tenants</h2>
			<%--<h2><g:message code="default.home.label"/></h2>--%>
				...
				<ul>
					<g:form controller="user" action="index">
						...
						<g:submitButton name="btnkhcbSubmit" value="1. PMCB Bank " class="medium blue awesome"/>
					</g:form>	
				</ul>
