...
<div class="body-scroll">
 <section> 
  <vayana:messages/>      
	  <g:form useToken="true" name="casaStmt" id="casaStmt">
	...
	/************ sorting buttons *************/
	 $( ".ascending")
        ...
        icons: { primary: "ui-icon-triangle-1-n"}
	 	...
	 	.click(function() {
        <g:remoteFunction controller="account" action="detailedstatementgotopage" update="mainContent" before='setSortOrder("asc")' params="\'sortOrder=\' + getSortOrder()+\'&sortBy=\'+getSortBy()+\'&gotoPage=\'+getPageNumber()"></g:remoteFunction>
        })
	 .next()
	 .button({
        text: false,
        icons: { primary: "ui-icon-triangle-1-s"}
 		...
 		<g:remoteFunction controller="account" action="detailedstatementgotopage" update="mainContent" before='setSortOrder("desc")' params="\'sortOrder=\' + getSortOrder()+\'&sortBy=\'+getSortBy()+\'&gotoPage=\'+getPageNumber()"></g:remoteFunction>
			}).parent()
                    .buttonset();
