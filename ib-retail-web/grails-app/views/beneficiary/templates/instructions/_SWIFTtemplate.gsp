...
<div class="fields">
	<p>
		<label for="bankCode"><g:message code="beneficiary.templates.instructions.swifttemplate.bankcode.label"/></label>
		 <g:textField name="bankCode" id="bankCode" value="${beneficiaryInstruction?.payeeBankBranch?.bankCode}" required="required"
			title="${g.message(code:'beneficiary.templates.instructions.swifttemplate.bankcode.label.tooltip.text')}"	
			readonly="true" data-errormessage="${g.message(code:"beneficiary.templates.instructions.swifttemplate.bankcode.label.error.message")}" />
			&nbsp;&nbsp;
			<g:remoteLink  controller="beneficiary" action="loadsearchBankForm" update="bankdialog" onSuccess="openBankDialog()" params="[bankType:'FOREIGN']">
			<g:message code="beneficiary.templates.instructions.swifttemplate.search.label"/>
			</g:remoteLink>
	</p>
</div>
...
<div class="fields">
	<p>
		<label for="bankName"><g:message code="beneficiary.templates.instructions.swifttemplate.bankname.label"/></label>
		<g:textField name="bankName" id="bankName" value="${bankDetails?.name1}" required="required"
			title="${g.message(code:'beneficiary.templates.instructions.swifttemplate.bankname.label.tooltip.text')}"	
			data-errormessage="${g.message(code:"beneficiary.templates.instructions.swifttemplate.bankname.label.error.message")}" />
	</p>
</div>
<div class="fields">
	<p>
		<label for="branchName"><g:message code="beneficiary.templates.instructions.swifttemplate.branchname.label"/></label>
		<g:textField name="branchName" id="branchName" value="${bankDetails?.branch1}" required="required"
			title="${g.message(code:'beneficiary.templates.instructions.swifttemplate.branchname.label.tooltip.text')}"	
			data-errormessage="${g.message(code:"beneficiary.templates.instructions.swifttemplate.branchname.label.error.message")}" />
	</p>
</div>		
<div class="fields">
	<p>
		<label for="bankAddress"><g:message code="beneficiary.templates.instructions.swifttemplate.branchaddress.label"/></label>
		<g:textField name="bankAddress" id="bankAddress" value="${bankDetails?.address1}"
			title="${g.message(code:'beneficiary.templates.instructions.swifttemplate.bankAddress.label.tooltip.text')}"	
			data-errormessage="${g.message(code:"beneficiary.templates.instructions.swifttemplate.bankAddress.label.error.message")}" />
	</p>
</div>	
</td>
