<div class="content">
	...
	<div class="content-wrap">
		<section class="app-section">
			<h2>
				${message(code:'firsttimelogin.templates.secretinfocontent.h2.text') }
			</h2>
			<p>
			...
			<g:form action="firstTimeLogin" controller="userProfile">
				...
				<div class="col-550">
					...
					<div class="fields">
						<p>
							<label for="agree"><input type="checkbox" id="agree"
								...
								<g:remoteLink controller="user" action="terms"
										class="ceebox" 
					...
					<div class="buttons">										
						<g:submitButton name="firstTimeSecretInfoSubmit"
							value="${message(code:'userregistration.templates.secretinfocontent.submit.button.text') }" 
							onclick="preCheck()"/>
