...
<head>
<title>
	${message(code:'errors.error500.title')}
</title>
...
<body>
	<h1 style="margin-left: 20px; color: #cc0000;">
		...
		${message(code:'errors.error500.unexpected.error.message')}
		<br />
		${message(code:'errors.error500.tryagain.error.message')}
		<a
			href="mailto:ibsupport@pmcbank.com?
		...
		${message(code:'errors.error500.itteam.error.message')}
