...
<div class="f-panel">
	...
	<div class="f-panel" id="ftpanel">
		<h2>
			<g:message code="payment.templates.prepaidcard.prepaidcardpayment.h2.text" />
			${params.payeeNickName}
			<g:if test="${favouritePaymentDetail != null }">
				<span id="favpayment"><input type="checkbox"
					name="checkbox${favouritePaymentDetail?.id}"
					id="checkbox${favouritePaymentDetail?.id}"
		...
		<g:form name="transferForm" controller="payment">
			...
			<%--<div class="mandi-note">
				...
				<p>
					<g:message code="payment.templates.prepaidcard.prepaidcardpayment.mandatory.fields.label" />
				</p>
			</div>
			--%><div class="fields">
				<p>
					<label for="from_account"><g:message code="payment.templates.prepaidcard.prepaidcardpayment.youraccount.label" /></label>
					<vayana:fromAccountSelect id="fromAccountId" name="fromAccountId"
						type="OA" poptype="BOTH"
			...
			<div class="fields">
				<p>
					...
					<vayana:toAccountSelect name="toAccountId" id="toAccountId"
						type="OA" poptype="PC" visible="true"
						noSelection="${['Select Payer Account':'Select Payer Account']}"
						required="required"
			...
			<div class="fields" id="currency">
				<p>
					...
					<vayana:tenantOpsCurrencySelect name="currencyId" id="currencyId" type="code"
						class="cur" from="${transferCurrency}"
						 required="required"
