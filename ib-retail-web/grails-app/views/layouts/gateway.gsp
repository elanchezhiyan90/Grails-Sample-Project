...
<link rel="stylesheet" type="text/css" class="cssfx" href="${resource(dir: 'themes/' + themeName  + '_theme/css', file: 'app.css')}" />
...
<body class="login" oncontextmenu="return false" onkeydown="if ((arguments[0] || window.event).ctrlKey) return false">
		<vayana:errors/>
		<g:layoutBody />
