Overseas Bank Account
   ...
   <g:if test ="${beneInstructionCmd?.beneInsId}">
		<section>
		        <h2><g:message code="beneficiary.templates.instructions.wiretemplate.accontdetails.h2.text"/></h2>
		        <form>
   ...
   <input type="hidden" name="tstCode" id="tstCode" value="${beneInsRespone?.getBeneInstructionTemplate()}"/>
			 <g:hiddenField name="paymentTypeUid" value="OBA" />	
			  <div class="fields">    
			   <p>
              <label for="pymt_type"><g:message code="beneficiary.templates.instructions.wiretemplate.paymentmode.label"/></label>
   ...
   <g:if test ="${beneInstructionCmd?.beneInsId}">
            ...
            <div class="fields">
              <p>
                <label for="bene_label"><g:message code="beneficiary.templates.instructions.wiretemplate.benenickname.label"/></label>
                <input type="text" name="beneInsShortName" id="beneInsShortName" size="20" value="${beneInstructionCmd?.beneInsShortName}" />
              </p>
            </div>
            <div class="fields">
              <p>
                <label for="bene_label"> <g:message code="beneficiary.templates.instructions.wiretemplate.nationality.label"/></label>
                <input type="text" name="bene_nationality" id="bene_nationality" size="20" value="" />
              </p>
            </div>
            <div class="fields">
                                  <p>
                                    <label for="city"> <g:message code="beneficiary.instructions.bankname.label"/></label>
                                     <g:select   id="bankUid" 
					                             name='bankUid' 
            ...
            <div class="fields">
              <p>
                <label for="bene_label"><g:message code="beneficiary.templates.instructions.wiretemplate.bic/swiftcode.label"/></label>
                <input type="text" name="swift" id="swift" size="20" value="" />
              </p>
            </div>
            <div class="fields">
              <p>
                <label for="bene_label"><g:message code="beneficiary.templates.instructions.wiretemplate.streetname.label"/></label>
                <input type="text" name="street_name" id="street_name" size="20" value="" />
              </p>
            </div>
            <div class="fields">
              <p>
                <label for="bene_label"><g:message code="beneficiary.templates.instructions.wiretemplate.postalcode.label"/></label>
                <input type="text" name="postal_code" id="postal_code" size="20" value="" />
              </p>
            </div>
             <div class="fields">
              <p>
                <label for="bene_label"><g:message code="beneficiary.templates.instructions.wiretemplate.beneaccounttype.label"/></label>
...
<%--              	<vayana:select name="accountTypeUid"  id = "accountTypeUid" from = "${accounts}" required="required" data-errormessage="Please select an account type"   /> --%>
		...
		<div class="fields">
			<p>
				<label for="bene_label"><g:message code="beneficiary.templates.instructions.wiretemplate.accountcurrency.label"/></label>
		...
		<div id="divBeneInsLimit">
            ...
            <div class="fields">
              <p>
                <label for="bene_label"> <g:message code="beneficiary.templates.instructions.wiretemplate.accontnumberoriban.label"/></label>
                <input type="text" name="iban" id="iban" size="20" value="${beneInstructionCmd?.iban}" />
              </p>
            </div>
            <div class="fields">
              <p>
                <label for="bene_label"><g:message code="beneficiary.templates.instructions.wiretemplate.confirmaccountnumberoriban.label"/></label>
