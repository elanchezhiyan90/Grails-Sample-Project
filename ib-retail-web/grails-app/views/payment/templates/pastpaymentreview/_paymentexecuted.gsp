...
<%--					<td></td>--%>
					...
					<td>
						${(PayeeTypeEnum?.BENE.equals(paymentDetails?.payeeInstruction?.payeeType)) ? vayana.formatFFAccountNumber(beneInsIdVer:paymentDetails?.payeeInstruction?.idVersion,displayCurrency:'YES') 
						...
						<%--<vayana:formatAccount
										...
										accountno="${paymentDetails?.payeeInstruction?.accountNumber}" />--%>
					</td>
					<td class="amt">
						<vayana:formatAmount
