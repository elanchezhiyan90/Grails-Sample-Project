<div class="t-panel">
	...
	<h2><g:message code="payment.templates.loan.loanpaymentfavourite.h2.text" /></h2>
	<%--<h3>
	<g:message code="payment.templates.loan.loanpaymentfavourite.h3.text" />
	...
	<vayana:favouriteSchPayment secondaryAction="ownscheduledfavourite" primaryModel="${favPaymentDetailModel}" secondaryController="payment" moduleType="OA" paymentType="SP"/>
	--%><h3>
	<g:message code="payment.templates.loan.loanpaymentfavourite.pastpayments.label" />
	...
	<vayana:favouritePastPayment secondaryAction="ownpastpaymentfavourite" primaryModel="${favPaymentDetailModel}" secondaryController="payment" moduleType="OA" paymentType="PP"/>
