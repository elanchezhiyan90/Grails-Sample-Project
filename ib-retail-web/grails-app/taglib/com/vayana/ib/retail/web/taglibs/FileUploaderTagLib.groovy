...
import com.vayana.ib.retail.web.taglibs.exception.InvalidAttributeValueException
import com.vayana.ib.retail.web.taglibs.exception.MissingRequiredAttributeException
import com.vayana.ib.retail.web.taglibs.exception.UnknownAttributeException
...
class FileUploaderTagLib {
    ...
    static final Map<String, List<String>> OPTIONAL_ATTRIBUTES = [
            allowedExtensions: ['jpg','jpeg','gif','png','csv'],
            sizeLimit: [],
            minSizeLimit: [],
            debug: ['true', 'false'],
            params: [],
